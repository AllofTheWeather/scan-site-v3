    ...
    return (
        ...
        <div className="container">
            <div className="card text-center mt-3 mb-3">
                <img src={office} className="card-img-top" alt="by Victor on Unsplash" />
                <div className="card-body">
                    <p className="card-text">We're a small team with a lot of experience providing rapid high quality scans at competative rates</p>
                    <a href="about" className="btn btn-primary">Meet the team</a>
                </div>
            ...
            <section className="container">
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="#" className="btn btn-primary">Clients</a>
                    </div>
                </div>
